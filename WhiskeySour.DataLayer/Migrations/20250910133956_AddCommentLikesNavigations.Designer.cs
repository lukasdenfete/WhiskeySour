...
namespace WhiskeySour.DataLayer.Migrations
{
    ...
    [Migration("20250910133956_AddCommentLikesNavigations")]
    partial class AddCommentLikesNavigations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WhiskeySour.DataLayer.CommentLike", b =>
                {
                    ...
                    b.HasOne("WhiskeySour.DataLayer.Comment", null)
            ...
            modelBuilder.Entity("WhiskeySour.DataLayer.Notification", b =>
                {
                    ...
                    b.HasOne("WhiskeySour.DataLayer.Thread", null)
                        .WithMany("Notifications")
